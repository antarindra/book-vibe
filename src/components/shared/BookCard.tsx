...
const BookCard = ({ book }: { book: Ibook }) => {
    return (
        <article className="group bg-white border border-gray-200 rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl flex flex-col justify-between">
            <div>
            ...
            <div className="px-6 pb-6 pt-4">
                <Link
                    ...
                    className="block w-full text-center bg-[#23BE0A] hover:bg-[#1ea209] text-white font-semibold py-2.5 rounded-xl transition-colors duration-300"
                >
                    View Details
                </Link>
            </div>
